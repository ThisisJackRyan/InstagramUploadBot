...
#retrieves name for removing account
def getName():
    ...
    #deletes account that is stored through Keyring
def remove(n):
    tempN =n.get()
...
#checks Who you are and achives the right info and accounts for the login
def check(n,u,p):
    tempN = n.get()
    tempU = u.get()
    tempP = p.get()
